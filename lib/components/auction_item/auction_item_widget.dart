...
export 'auction_item_model.dart';
...
class _AuctionItemWidgetState extends State<AuctionItemWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuctionItemModel());
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: custom_widgets.CustomStopwatchCountDown(
                      width: 70.0,
                      height: 30.0,
                      secondsToShow: functions.stringToInt(getJsonField(
                        widget.jsonResult,
                        r'''$.remainingTime''',
                      ).toString()),
