...
import 'vehicles_purchased_model.dart';
export 'vehicles_purchased_model.dart';

class VehiclesPurchasedWidget extends StatefulWidget {
  const VehiclesPurchasedWidget({Key? key}) : super(key: key);

  @override
  _VehiclesPurchasedWidgetState createState() =>
      _VehiclesPurchasedWidgetState();
}

class _VehiclesPurchasedWidgetState extends State<VehiclesPurchasedWidget> {
  late VehiclesPurchasedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VehiclesPurchasedModel());
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  's86pr6ze' /* My Favourite Vehicles */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                ...
                child: Container(
                  ...
                  child: FutureBuilder<ApiCallResponse>(
                    future: (_model.apiRequestCompleter ??= Completer<
                            ApiCallResponse>()
                          ..complete(EFDevGroup.listPurchasedVehiclesCall.call(
                            language: FFLocalizations.of(context).languageCode,
                            userBuyerId: FFAppState().UserId,
                    ...
                    builder: (context, snapshot) {
                      ...
                      final rowListPurchasedVehiclesResponse = snapshot.data!;
                      return Row(
                        mainAxisSize: MainAxisSize.max,
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                                                    ...
                                                                    child: FutureBuilder<
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return FlutterFlowDropDown<
                                                                          ...
                                                                          hintText:
                                                                              FFLocalizations.of(context).getText(
                                                                            'wi0fgf3t' /* Select Sub-user */,
                                                                          ),
                                                                          searchHintText:
                                                                              FFLocalizations.of(context).getText(
                                                                            'q8ewprxn' /* Search for an item... */,
                                                                          ),
                                                                          fillColor:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        Builder(
                                                                          builder:
                                                                              (context) {
                                                                            final purchasedVehiclesM =
                                                                                getJsonField(
                                                                              rowListPurchasedVehiclesResponse.jsonBody,
                                                                              r'''$.items''',
                                                                            ).toList();
                                                                            if (purchasedVehiclesM.isEmpty) {
                                                                            ...
                                                                            return ListView.builder(
                                                                              ...
                                                                              shrinkWrap: true,
                                                                              scrollDirection: Axis.vertical,
                                                                              itemCount: purchasedVehiclesM.length,
                                                                              itemBuilder: (context, purchasedVehiclesMIndex) {
                                                                                final purchasedVehiclesMItem = purchasedVehiclesM[purchasedVehiclesMIndex];
                                                                                return InkWell(
                                                                                  onTap: () async {
                                                                                  ...
                                                                                  child: PurchasedSoldItemWidget(
                                                                                    key: Key('Keyqnz_${purchasedVehiclesMIndex}_of_${purchasedVehiclesM.length}'),
                                                                                    jsonResult: purchasedVehiclesMItem,
                                                                                    isSold: false,
                                                                                  ),
                                                                                );
                                                                              },
                                            ...
                                            if (functions
                                                  ...
                                                  rowListPurchasedVehiclesResponse
                                                      .jsonBody,
                                                  r'''$.totalCount''',
                                                ).toString()) >
                                                0)
                                                                  ...
                                                                  child: FutureBuilder<
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return FlutterFlowDropDown<
                                                                        ...
                                                                        hintText:
                                                                            FFLocalizations.of(context).getText(
                                                                          'jhie4vkk' /* Select Sub-user */,
                                                                        ),
                                                                        searchHintText:
                                                                            FFLocalizations.of(context).getText(
                                                                          'jw8tuyga' /* Search for an item... */,
                                                                        ),
                                                                        fillColor:
                                                                            FlutterFlowTheme.of(context).primaryBackground,
                                                                        elevation:
                                                    ...
                                                    child:
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          Builder(
                                                            builder: (context) {
                                                              final purchasedVehicles =
                                                                  getJsonField(
                                                                rowListPurchasedVehiclesResponse
                                                                    .jsonBody,
                                                                r'''$.items''',
                                                              ).toList();
                                                              if (purchasedVehicles
                                                                  .isEmpty) {
                                                                return EmptyStateWidget();
                                                              }
                                                              return ListView
                                                                ...
                                                                itemBuilder:
                                                                    (context,
                                                                        purchasedVehiclesIndex) {
                                                                  final purchasedVehiclesItem =
                                                                      purchasedVehicles[
                                                                          purchasedVehiclesIndex];
                                                                  return VehiclesPurchasedSoldWidget(
                                                                    key: Key(
                                                                        'Keyn2s_${purchasedVehiclesIndex}_of_${purchasedVehicles.length}'),
                                                                    jsonVehicles:
                                                                        purchasedVehiclesItem,
                                                                    isSold:
                                                                        false,
                                                                  );
                                                                },
